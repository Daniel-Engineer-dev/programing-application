...
import { MessageSquare, ThumbsUp, ThumbsDown, Eye, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-900 text-slate-200">
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white">Trang Thảo Luận</h1>
        ...
        <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            {/* Lọc theo chủ đề */}
            <div>
              <label className="mr-2 text-xs text-slate-400">Chủ đề</label>
              <select
                value={topicFilter}
            ...
            {/* Sắp xếp */}
            <div>
              <label className="mr-2 text-xs text-slate-400">Sắp xếp</label>
              <select
                value={sortBy}
                onChange={(e) =>
              ...
              >
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-400">{d.excerpt}</p>
                  ...
                  <div className="mt-2 flex shrink-0 flex-col items-end gap-1 text-xs text-slate-400">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="inline-flex items-center gap-1">
                        <MessageSquare size={14} /> {d.repliesCount} Phản hồi
                      </span>
                    </div>
                    <span className="inline-flex items-center gap-1">
