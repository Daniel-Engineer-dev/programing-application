        ...
        <main className="mx-auto max-w-6xl px-6 py-16 relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-slate-900 border border-slate-800">
              ...
              <span className="text-sm text-slate-300 font-medium">Cuộc Thi Lập Trình</span>
            </div>
          ...
          {/* Tab Buttons */}
          <div className="flex flex-wrap gap-3 justify-center mb-10 bg-slate-900 border border-slate-800 rounded-2xl p-3 max-w-2xl mx-auto">
            <button
              onClick={() => setActiveTab("ONGOING")}
              className={`flex-1 min-w-[120px] px-5 py-3 rounded-xl text-sm font-semibold border transition-all duration-200 ${
                activeTab === "ONGOING"
          ...
          <div className="space-y-5">
            ...
            {error && (
              <div className="text-center py-10 bg-slate-900 border border-red-500/30 rounded-2xl p-6">
                  ...
                  <div className="rounded-2xl bg-slate-900 border border-slate-800 p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm hover:border-rose-500/60 transition-all duration-200 animate-fadeIn">
                    ...
                    <div className="space-y-4 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="inline-flex items-center gap-2 mb-3">
                            {contest.computedStatus === "ONGOING" && (
                              <span className="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-bold uppercase flex items-center gap-1.5 shadow-sm">
                                <Zap className="w-3 h-3" />
                                Đang diễn ra
                              </span>
                            )}
                            {contest.computedStatus === "UPCOMING" && (
                              <span className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20 text-xs font-bold uppercase flex items-center gap-1.5 shadow-sm">
                                <Clock className="w-3 h-3" />
                                Sắp diễn ra
                              </span>
                            )}
                            {contest.computedStatus === "ENDED" && (
                              <span className="px-3 py-1 rounded-full bg-slate-800 text-slate-400 border border-slate-700 text-xs font-bold uppercase shadow-sm">
                                Đã kết thúc
                              </span>
                            )}
                          </div>
                      ...
                      <div className="flex flex-wrap gap-2 text-xs">
                        <span className="px-3 py-2 rounded-lg bg-slate-800/80 text-slate-300 border border-slate-700/50 font-medium">
                          <Calendar className="w-3 h-3 inline mr-1.5 text-blue-400" />
                          {contest.dateText}
                        </span>

                        <span className="px-3 py-2 rounded-lg bg-slate-800/80 text-slate-300 border border-slate-700/50 font-medium">
                          <Clock className="w-3 h-3 inline mr-1.5 text-blue-400" />
                          {contest.timeText}
                        </span>
                        ...
                        <span className="px-3 py-2 rounded-lg bg-slate-800/80 text-slate-300 border border-slate-700/50 font-medium">
                          <Users className="w-3 h-3 inline mr-1.5 text-blue-400" />
                    ...
                    <div className="md:ml-6">
                      {contest.computedStatus === "ENDED" ? (
                        <button
                          disabled
                          className="w-full md:w-auto rounded-xl bg-slate-800 px-6 py-3 text-sm font-semibold text-slate-500 border border-slate-700 cursor-not-allowed"
                        >
                          Đã kết thúc
                        </button>
                        ...
                        <button
                          ...
                          className="w-full md:w-auto rounded-xl bg-green-500/10 px-6 py-3 text-sm font-semibold text-green-400 border border-green-500/20 cursor-not-allowed flex items-center gap-2 justify-center"
                        >
                        ...
                        <button
                          ...
                          className={`w-full md:w-auto rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white hover:bg-blue-500 transition-all duration-200 shadow-sm ${
